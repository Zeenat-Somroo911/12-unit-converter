  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-gradient-to-r from-green-400 to-blue-500">
      ...
      <div className="max-w-md w-full p-6 bg-white rounded-lg shadow-lg">
        <h1 className="text-3xl font-bold mb-1 text-center text-green-700">Unit Converter</h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div className="space-y-2 col-span-2">
            ...
            <Input
              ...
              className="w-full border-2 border-black-500 focus:border-green-500"
            />
          </div>
          {/* Button to trigger conversion */}
          <Button
            type="button"
            className="col-span-2 bg-green-600 text-white hover:bg-green-700 transition duration-300"
      ...
      <footer className="mt-6 text-center text-black">
